...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <>
      {/* Toggle Button — positioned in top-right, only visible on mobile via parent CSS */}
      <button
        ref={toggleBtnRef}
        className="sm-toggle"
        ...
        type="button"
        style={{
          transform: (!open && navHidden) ? 'translateY(-100px)' : 'translateY(0)',
                ...
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap" key={it.label + idx}>
                    <a
                      ...
                      data-index={idx + 1}
                      data-active={
                        activeItemId === it.id ? "true" : undefined
                      }
